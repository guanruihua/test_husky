export default {
  ...
  'global.validate.inputNumMinMax':
    '請輸入壹個 {minNum} 到 {maxNum} 之間的數字', // 輸入驗證，只允許輸入數字，區間 [minNum, maxNum]
  ...
  'global.validate.input.str.front':
    "只允許字母數字或下劃線，不能以 '{str}' 開頭",
  'global.validate.input.login':
    '用戶名由字母數字或下劃線組成，且不能以數字開頭',
  'global.validate.input.phoneNum':
    '格式有誤，正確格式為：地區代碼-號碼；例：+86-13212341234',
  ...
  'global.imageUploader.pixelConfirm':
    '妳的圖片尺寸不是推薦的{width}×{height} PX,依舊上傳嗎？',
